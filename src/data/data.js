...
export const projects = [
    {
      title: "Wolfer",
      subtitle: "React Native (expo) game. - React frontend, Node.js API & websocket backend.",
      description:
    ...
    {
      title: "QuackHost.uk",
      subtitle: "PHP client panel for free hosting services.",
      description:
    ...
    {
        title: "Shadow's Dash",
        subtitle: "A PHP client panel for hosting services.",
        description:
