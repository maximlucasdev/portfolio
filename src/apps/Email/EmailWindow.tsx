...
export default function EmailWindow() {
  return (
    <div class='flex flex-col items-center justify-center h-full w-full rounded-b-md text-center'>
        ...
        <a href='mailto:contact@maximlucas.dev' class='text-gray-400 hover:text-white text-2xl mb-4 hover:scale-105 transition' target='_blank'>contact@maximlucas.dev</a>
    </div>
  )
}
