...
export default function WelcomePopup(props:any) {
  ...
  return (
    ...
    <Animated animationIn="slideInUp" animationInDuration={500} animationOut="fadeOut" animationOutDuration={500} isVisible={visible}>
      <div class='bg-stone-700/20 border-white/10 md:border-[1px] backdrop-blur-sm w-screen md:w-[500px] rounded-lg px-2 md:px-5'>
        <div class='flex flex-row gap-2 items-center p-2'>
          ...
          <div class='flex flex-col justify-center'>
            ...
            <p class='text-gray-400 text-sm mb-2'>{t('welcome.desc2')}</p>
            <p class='text-gray-400 text-sm mb-2'>{t('welcome.desc3')}</p>
