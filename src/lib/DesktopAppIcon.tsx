    ...
    <>
      ...
      onDrag={(e) => {
        e.preventDefault();
          ...
          <img draggable={false} src={props.app.icon} class='w-16 h-16 md:w-12 md:h-12 bg-gradient-to-t from-blue-900 to-blue-700 shadow md:shadow-none md:from-transparent md:to-transparent rounded-xl md:rounded-none p-3 md:p-0' alt={props.app.name + " icon"}/>
