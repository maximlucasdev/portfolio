...
const projects: Project[] = [
  {
    title: "Ctrl Alt Cat (2025-...)",
    subtitleEN: "My developement company.",
    subtitleFR: "Mon entreprise de développement.",
    descriptionEN:
      "Ctrl Alt Cat brings your ideas to life! This is my company that sells Shadow's Dash among other developement related products and services.",
    descriptionFR:
      "Ctrl Alt Cat donne vie à vos idées ! C'est mon entreprise qui vend Shadow's Dash parmi d'autres produits et services liés au développement.",
    image: "/projets/ctrlaltcat.png",
    link: "https://ctrlalt.cat",
    skillsName: ["Preact", "scss", "Go", "Bun", "Vite"],
  },
  {
    title: "SAEIV Naolib (2025)",
    subtitleEN:
      "I imagined what the display of Naolib passenger information of the future.",
    subtitleFR:
      "J'ai imaginé ce a quoi pourrait ressembler des SAEIV du futur pour Nantes.",
    descriptionEN:
      "I imagined what the display of Naolib passenger information (public transports in Nantes, France) of the future might look like, with screens at stops. The data is in real time.",
    descriptionFR:
      "J'ai imaginé ce a quoi pourrait ressembler l'affichage d'informations voyageurs Naolib (transports en commun à Nantes) du futur, avec des écrans aux arrêts. Les données sont en temps réel.",
    image: "/projets/naolib.png",
    link: "https://naolib.maximlucas.dev/",
    skillsName: ["Preact", "Open Data", "TailwindCSS", "Vite", "Bun"],
  },
  {
    title: "Shadow's Dash (2023-...)",
    subtitleEN:
      "Full Stack web fully featured modern client panel for Pterodactyl-based hosts",
    subtitleFR:
  ...
  },
  {
    title: "Naopark (2024-...)",
    descriptionEN:
      "An application to get the list of parking lots and the number of available spaces in real-time in Nantes. I created this application because it is not easy to find parking lots and their information in Nantes. (Available in France only)",
    descriptionFR:
      "Une application pour obtenir la liste des parkings ainsi que le nombre de place disponibles en direct à Nantes. J'ai réalisé cette application car on ne peut pas facilement trouver les parkings et leurs infos à Nantes.",
  ...
  },
  {
    ...
    descriptionEN:
      "A social network developed from scratch using React Native, Bun, and Elysia. Every day, users receive a picture challenge, friends can comment, react and more! Available on the Google Play Store (France), and on picsfiesta.com (French only).",
    descriptionFR:
      "Un réseau social développé de zéro utilisant React Native, Bun, et Elysia. Chaque jour, les utilisateurs reçoivent un défi photo, les amis peuvent commenter, réagir et plus encore ! Disponible sur le Google Play Store (France), et sur picsfiesta.com.",
  ...
  },
  {
    ...
    executable: "fishsim",
    subtitleEN:
      "French only: A project simulating fish and genetic evolution for a school project.",
    subtitleFR:
      "Un simulateur de poisson et d'évolution génétique pour un projet de NSI.",
    descriptionEN:
  ...
  },
  {
    ...
    subtitleEN:
      "FullStack website to download YouTube videos without ads or pop-ups. First project in Go!",
    subtitleFR:
      "Site Web FullStack pour télécharger des vidéos YouTube (ou autre) sans publicité ni pop-ups. Premier projet en Go !",
    descriptionEN:
  ...
  },
  {
    ...
    subtitleEN:
      "French only: A web recursive sudoku solver using backtracking.",
    subtitleFR:
      "Un résolveur de sudoku web récursif utilisant le backtracking.",
    descriptionEN:
  ...
  },
  {
    ...
    descriptionEN:
      "A cool and modern landing page for a hosting company. Includes a Q&A section, a plans section, and more. I think it ended up looking pretty cool, I like that alex skin flying at the bottom of the page :D",
    descriptionFR:
      "Une page d'accueil moderne et cool pour une entreprise d'hébergement. Comprend une section de questions-réponses, une section de plans, et plus encore. Je suis plutôt satisfait du résultat, j'aime bien ce skin d'alex qui vole en bas de la page :D",
  ...
  },
  {
    ...
    subtitleEN:
      "Free hosting services for Minecraft servers, Discord bots and more. Since 2021.",
    subtitleFR:
      "Services d'hébergement gratuits pour les serveurs Minecraft, les bots Discord et plus encore. Depuis 2021.",
    descriptionEN:
  ...
  },
  {
    ...
    subtitleFR:
      "Application FullStack pour les hébergeurs basés sur Pterodactyl",
    descriptionEN:
  ...
  },
  {
    ...
    subtitleEN:
      "Mobile online werewolf game from scratch (socketio server, backend, website, mobile app).",
    subtitleFR:
      "Jeu de loup-garou en ligne sur mobile de zéro (serveur socketio, backend, site web, application mobile).",
    descriptionEN:
  ...
  },
  {
    ...
    subtitleEN:
      "Client panel for pterodactyl-based hosts. First big project! (PHP)",
    subtitleFR:
      "Panneau client pour les hébergeurs basés sur Pterodactyl. Premier gros projet ! (PHP)",
    descriptionEN:
