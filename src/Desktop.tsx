...
export default function Desktop() {
  ...
  return (
    <>
      ...
      >
        <div
          class="bg-blue-500/30 absolute border-[1px] border-blue-500"
          style={{
            top:
        ...
        {isMobile ? (
          <div
            class="flex mt-8 items-baseline justify-evenly sm:justify-start gap-10  px-5 py-10 h-full flex-wrap p-2 w-screen content-start"
        ...
        >
          <p
            class={`absolute bottom-0 md:bottom-5 right-0 text-xs pr-2 pb-2 md:pb-0 md:pr-5 md:text-sm text-end text-white opacity-20`}
          >
        ...
        <Animated
          ...
          isVisible={!isAppFullscreen.value}
        >
          <p class="md:hidden w-full text-center absolute bottom-10 text-lg text-white">
            {t("looksbetteronpc")}
          </p>
        </Animated>
